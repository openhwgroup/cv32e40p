...
set DESIGN_NAME     "cv32e40p_mult_opt"
...
#analyze -format sverilog "../rtl/include/cv32e40p_pkg.sv ../rtl/cv32e40p_mult.sv"
analyze -format sverilog "../rtl/include/cv32e40p_pkg.sv ../rtl/cv32e40p_mult_opt.sv"
...
create_clock -name "clk" -period 35 -waveform {0 1} [get_ports clk]
set_propagated_clock [get_clocks clk]
set_dont_touch_network [get_clocks clk]

# Input delays
set_input_delay 0.1 -max -clock clk [get_ports rst_n]
set_input_delay 0.1 -max -clock clk [get_ports enable_i]
set_input_delay 0.1 -max -clock clk [get_ports operator_i]

# Output delays
set_output_delay 0.5 -max -clock clk [get_ports result_o]
set_output_delay 0.5 -max -clock clk [get_ports multicycle_o]
set_output_delay 0.5 -max -clock clk [get_ports mulh_active_o]
set_output_delay 0.5 -max -clock clk [get_ports ready_o]
