...
set DESIGN_NAME "cv32e40p_controller_COREV_CLUSTER"
...
analyze -format sverilog "../rtl/include/cv32e40p_pkg.sv ../rtl/cv32e40p_controller_COREV_CLUSTER.sv"
...
# Constraints 
create_clock -name "clk" -period 8.5 -waveform {0 1} [get_ports clk]
...
# Input delays
set_input_delay 0.1 -max -rise -clock clk [get_ports rst_n]
set_input_delay 0.1 -max -fall -clock clk [get_ports fetch_enable_i]

#Output delays
set_output_delay 0.5 -max -clock clk [get_ports ctrl_busy_o]
set_output_delay 0.5 -min -clock clk [get_ports ctrl_busy_o]

set_output_delay 0.5 -max -clock clk [get_ports is_decoding_o]
set_output_delay 0.5 -min -clock clk [get_ports is_decoding_o]
