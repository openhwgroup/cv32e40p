...
read_verilog "../syn/cv32e40p_controller_synthesized.v"

# Set top-level design
current_design cv32e40p_controller

# Create 200 MHz clock
create_clock -period 5 -name clk [find port clk]

# Load VCD for switching activity
read_vcd -strip_path cv32e40p_controller_tb/u_cv32e40p_controller "../sim/cv32e40p_controller_tb.vcd"
