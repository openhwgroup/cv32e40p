...
read_verilog "../syn/cv32e40p_controller_COREV_CLUSTER_synthesized.v"

# Set top-level design
current_design cv32e40p_controller_COREV_CLUSTER

# Create 200 MHz clock 5
create_clock -period 5 -name clk [find port clk]

# Load VCD for switching activity
read_vcd -strip_path cv32e40p_controller_COREV_CLUSTER_tb/u_cv32e40p_controller_COREV_CLUSTER "../sim/cv32e40p_controller_corev_cluster_tb.vcd"
